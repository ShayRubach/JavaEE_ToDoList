package com.lifemichael.javaee.controller;
...
import com.lifemichael.javaee.model.Contact;
...
public class AppController extends HttpServlet {
	...
	private void pagingManager(HttpServletRequest request, HttpServletResponse response, 
		...
		{
			nextState(request, response, "/feedback.html");
	...
	private String insertComment(HttpServletRequest request, HttpServletResponse response) throws ContactException {
		...
		else
		{
			...
			newComment = HibernateToDoListDAO.getInstance().addComment(contact);
			if (newComment != null) {
